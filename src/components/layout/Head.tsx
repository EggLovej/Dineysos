...
export default function SeoHead({
    ...
    const localizedTitle = title[locale as "de" | "en"];
    const localizedDescription = description[locale as "de" | "en"];
    ...
    return (
        <Head>
            ...
            {/* Hreflang for i18n */}
            <link rel="alternate" hrefLang="de" href={`https://dineysos.com/de${asPath}`} />
            <link rel="alternate" hrefLang="en" href={`https://dineysos.com/en${asPath}`} />
        </Head>
    );
}